package net.bitquill.adc.ocr;

import java.io.IOException;

import net.bitquill.adc.ocr.image.GrayImage;
import net.bitquill.adc.ocr.image.SimpleStructuringElement;
import net.bitquill.adc.ocr.weocr.WeOCRClient;
